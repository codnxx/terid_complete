...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int categoryID = intent.getIntExtra(ExampleActivity.EXTRA_CATEGORY_ID, 0);
        String categoryName = intent.getStringExtra(ExampleActivity.EXTRA_CATEGORY_NAME);
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            answered = false;
            buttonConfirmNext.setText("CHECK THE ANSWER");
